...
enum LC_maximize_sum_of_array_after_k_negations {
    ...
    @Suite struct MaximizeSumOfArrayAfterKNegationsTests {
        ...
        @Test static func test_0() async {
            ...
            let topic = "greedy"
            let testId = "9cf18b0f-4e72-47d0-991b-2439e29895b6"
        ...
        @Test static func test_1() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "4df17fab-34b6-458c-9842-c96f2609dfd7"
        ...
        @Test static func test_2() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "4c4a2eb0-3ae7-44cd-9358-b71cef83f497"
        ...
        @Test static func test_3() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "100c8f14-1557-4998-818c-62dd122baf00"
        ...
        @Test static func test_4() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "49f8a395-d8cc-428b-bef1-88fd296c6189"
        ...
        @Test static func test_5() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "9ecf0109-186a-4f4a-9764-986c888c240e"
            let rawInput = "nums = [-10,-10,-10,-10,-10], k = 5"
        ...
        @Test static func test_6() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "c377501d-8291-4b85-9efb-1396ef6e718c"
        ...
        @Test static func test_7() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "7304d059-fa2c-4138-8689-529730fcd40f"
        ...
        @Test static func test_8() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "28c550a1-f5ed-40e9-9d42-e8047b1954cf"
            let rawInput = "nums = [-1,-2,-3], k = 1"
            let expectedOutput = "0"
            let orderMatters = true
        ...
        @Test static func test_9() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "65a13df2-9aec-4b75-9817-e5c96d25bd64"
            let rawInput = "nums = [-1,-2,-3], k = 3"
            let expectedOutput = "6"
            let orderMatters = true
        ...
        @Test static func test_10() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "628b8bc0-5287-401b-812f-30ac4df2c0cf"
        ...
        @Test static func test_11() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "33c4d178-cee7-41a2-8f4b-58459d0bfe05"
            let rawInput = "nums = [], k = 1"
            let expectedOutput = "-9223372036854775808"
            let orderMatters = true
        ...
        @Test static func test_12() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "e84cf20e-e9f8-4444-bd7c-7bbd9f5203df"
        ...
        @Test static func test_13() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "a9f71afc-b18b-467f-ad6c-4ea18ce5bfd7"
        ...
        @Test static func test_14() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "196c5507-6695-4b2b-9d53-fdab3ca0a3e7"
        ...
        @Test static func test_15() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "1c63c3de-2cf7-4457-a3dd-9ec2d692bc35"
        ...
        @Test static func test_16() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "aa6fa95a-906d-4d48-8cf0-478c3937a4f3"
        ...
        @Test static func test_17() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "d86fbbd4-c096-4b88-8302-1f3f9a77c785"
            let rawInput = "nums = [-10,-20,-30], k = 1"
            let expectedOutput = "0"
            let orderMatters = true
        ...
        @Test static func test_18() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "ebbb1396-a7a7-4034-b6a1-8b6407a7fd9a"
            let rawInput = "nums = [-10,-20,-30], k = 3"
            let expectedOutput = "60"
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "98705884-f275-406a-ac87-3f9c603169ad"
        ...
        @Test static func test_20() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "0ba56508-f095-455d-9183-f1d28f845faf"
        ...
        @Test static func test_21() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "ed9db750-0930-4908-b2d5-cb3cec48fcc9"
            let rawInput = "nums = [-1000,-2000,-3000], k = 1"
            let expectedOutput = "0"
            let orderMatters = true
        ...
        @Test static func test_22() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "813ca785-1d7f-4c0c-aea5-b1d3f33097ca"
            let rawInput = "nums = [-1000,-2000,-3000], k = 3"
            let expectedOutput = "6000"
            let orderMatters = true
        ...
        @Test static func test_23() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "e5065e5d-4711-4d88-aaf3-9cafcccf6001"
        ...
        @Test static func test_24() async {
            let slug = "maximize-sum-of-array-after-k-negations"
            let topic = "greedy"
            let testId = "94344c07-16d9-42e9-a255-aa81366a0b06"
