...
enum LC_combinations {
    ...
    @Suite struct CombinationsTests {
        ...
        @Test static func test_0() async {
            ...
            guard p_k >= 1 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 1 <= k <= n")
                return
            }
