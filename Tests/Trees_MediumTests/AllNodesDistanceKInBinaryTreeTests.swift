...
enum LC_all_nodes_distance_k_in_binary_tree {
    ...
    @Suite struct AllNodesDistanceKInBinaryTreeTests {
        ...
        @Test static func test_0() async {
            ...
            guard p_k >= 0 && p_k <= 1000 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 0 <= k <= 1000")
                return
            }
