    ...
    @Suite struct AddOneRowToTreeTests {
        ...
        @Test static func test_0() async {
            ...
            guard p_val >= -105 && p_val <= 105 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: -105 <= val <= 105")
                return
            }
