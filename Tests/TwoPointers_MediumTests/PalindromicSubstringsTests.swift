...
enum LC_palindromic_substrings {
    ...
    @Suite struct PalindromicSubstringsTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "c8fc039d-3236-40e7-97de-6ed52e7d2b71"
            let rawInput = "s = \"abc\""
        ...
        @Test static func test_1() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "fc185f7d-faf2-49c5-93d1-69b104559c8f"
            let rawInput = "s = \"abcd\""
        ...
        @Test static func test_2() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "d4fbe8a9-1b03-493e-814c-121b0335c484"
            let rawInput = "s = \"a\""
        ...
        @Test static func test_3() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "ac08dff0-9984-4619-a061-79c378cae57e"
        ...
        @Test static func test_4() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "1f455b7a-99cc-4e81-8520-826a895cd2d8"
            let rawInput = "s = \"civic\""
        ...
        @Test static func test_5() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "e3448217-70de-4af9-b902-27747574d69b"
            let rawInput = "s = \"pop\""
            let expectedOutput = "4"
            let orderMatters = true
        ...
        @Test static func test_6() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "db94298e-8156-403d-98cd-2088b9170261"
        ...
        @Test static func test_7() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "76a4bfbc-bbf4-4483-bd50-1a02328441ba"
            let rawInput = "s = \"aibohphobia\""
        ...
        @Test static func test_8() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "830e7152-6009-428c-83f1-e3a86c17e631"
            let rawInput = "s = \"\""
        ...
        @Test static func test_9() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "79e2eba4-34c5-4eef-bcd9-a53254283a2f"
        ...
        @Test static func test_10() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "a22f8cd4-bd79-4781-a955-637629d358ad"
        ...
        @Test static func test_11() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "357392c3-f090-4df2-91dc-fb070dac75fd"
        ...
        @Test static func test_12() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "0ced8e7f-b4d9-4845-90d6-d00d6d2dc781"
        ...
        @Test static func test_13() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "f834ba33-5b67-4f29-9b54-f645ad4a5d3f"
            let rawInput = "s = \"abcdefgha\""
        ...
        @Test static func test_14() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "0e33c58f-dffa-4059-959f-7486f45aaab0"
            let rawInput = "s = \"abcdefghab\""
            let expectedOutput = "10"
            let orderMatters = true
        ...
        @Test static func test_15() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "bb8e064c-8b31-42b5-a00d-765ed0ef8ca2"
            let rawInput = "s = \"abba\""
        ...
        @Test static func test_16() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "6a6a0f25-46d4-4fca-995b-155894b437b8"
        ...
        @Test static func test_17() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "9468ee2d-8920-47bc-a058-dc7d36f94fa9"
        ...
        @Test static func test_18() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "5a53a8ff-5a05-43d7-8d2b-934c2abb0191"
            let rawInput = "s = \"rotator\""
            let expectedOutput = "10"
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "d50e196b-ba3a-445d-bda9-f64004f8c8d8"
            let rawInput = "s = \"repaper\""
            let expectedOutput = "10"
            let orderMatters = true
        ...
        @Test static func test_20() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "45e7b5ad-ee51-4e7c-9999-f1b69bab4592"
        ...
        @Test static func test_21() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "adb93e3f-ebb7-4021-893a-50b1c4279682"
        ...
        @Test static func test_22() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "64440864-b29c-4ff0-8273-c7cd07829e66"
            let rawInput = "s = \"noon\""
            let expectedOutput = "6"
            let orderMatters = true
        ...
        @Test static func test_23() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "c29d39c4-ae38-4194-8196-c43f668d75c8"
            let rawInput = "s = \"tattarrattat\""
        ...
        @Test static func test_24() async {
            let slug = "palindromic-substrings"
            let topic = "two-pointers"
            let testId = "db0d1abe-80f1-4f1d-b5a9-0474da994edd"
