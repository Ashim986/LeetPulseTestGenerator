...
enum LC_alien_dictionary {
    ...
    @Suite struct AlienDictionaryTests {
        ...
        @Test static func test_0() async {
            ...
            let topic = "misc"
            let testId = "eadd66a6-bb30-44e6-a598-9b12a0441ba7"
        ...
        @Test static func test_1() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "7e24f77a-5d53-4800-ab76-e474273383a3"
            let rawInput = "words = [\"a\",\"b\",\"c\",\"d\"]"
        ...
        @Test static func test_2() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "82734f8d-86f6-4b28-a564-21c215a7fd0a"
        ...
        @Test static func test_3() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "3ffadfbc-1b9e-4a1e-adfc-7eb3a1950b26"
        ...
        @Test static func test_4() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "314acc4d-ee93-4cb7-aac9-c91026393345"
            let rawInput = "words = [\"abc\",\"abcd\",\"abce\"]"
        ...
        @Test static func test_5() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "35c22dc3-85c2-4e91-ac80-74f0b6616084"
        ...
        @Test static func test_6() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "72bcfe36-569b-4ff3-842c-26775b4fb58d"
        ...
        @Test static func test_7() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "ca34bac6-c344-4e78-8105-0de39d95c246"
        ...
        @Test static func test_8() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "c64c5f9f-92c1-41d0-ae01-e2c164cfa766"
            let rawInput = "words = [\"baa\",\"abcd\",\"abca\",\"cab\",\"cad\"]"
            let expectedOutput = "bdac"
            let orderMatters = true
        ...
        @Test static func test_9() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "6a7f3418-ce22-4343-9841-dd62121619b4"
            let rawInput = "words = [\"q\",\"r\",\"s\",\"t\",\"u\",\"v\",\"w\",\"x\",\"y\",\"z\"]"
            let expectedOutput = "qrstuvwxyz"
            let orderMatters = true
        ...
        @Test static func test_10() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "d619f329-e1ce-4ff2-8951-597fe132a167"
            let rawInput = "words = [\"abc\",\"def\",\"ghi\"]"
            let expectedOutput = "abcefhidg"
            let orderMatters = true
        ...
        @Test static func test_11() async {
            let slug = "alien-dictionary"
            let topic = "misc"
            let testId = "c6a2fc02-a645-4b45-88f3-00568cf4ff91"
            let rawInput = "words = [\"cba\",\"daf\",\"ghi\"]"
            let expectedOutput = "abcfhidg"
            let orderMatters = true
