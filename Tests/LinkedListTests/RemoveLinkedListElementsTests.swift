...
@Suite struct RemoveLinkedListElementsTests {
    ...
    @Test func test_0() async {
        ...
        guard p_val >= 0 && p_val <= 50 else {
            await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, outputMatches: false, orderMatters: orderMatters, errorMessage: "Constraint violation: 0 <= val <= 50")
            return
        }
