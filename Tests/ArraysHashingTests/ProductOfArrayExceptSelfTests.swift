...
@Suite struct ProductOfArrayExceptSelfTests {
    ...
    @Test func test_0() async {
        ...
        guard p_nums.allSatisfy({ $0 >= -30 && $0 <= 30 }) else {
            await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: -30 <= nums[i] <= 30")
            return
        }
