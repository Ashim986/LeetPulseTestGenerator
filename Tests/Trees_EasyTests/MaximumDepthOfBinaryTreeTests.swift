...
enum LC_maximum_depth_of_binary_tree {
    ...
    @Suite struct MaximumDepthOfBinaryTreeTests {
        ...
        @Test static func test_0() async {
            ...
            let topic = "trees"
            let testId = "ba41e9a9-4cae-4b50-a6a1-ac21c66c7b5e"
            let rawInput = "root = []"
            ...
            do {
                ...
                let result = solution.maxDepth(p_root)
        ...
        @Test static func test_1() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "3e5be7c4-9d4a-4345-93cf-5814cd9079cd"
            let rawInput = "root = [1]"
        ...
        @Test static func test_2() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "355cece4-b087-4829-a32a-4ca3e5c14b1b"
        ...
        @Test static func test_3() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "9e473022-10e8-49d6-a157-da8e26e3f637"
        ...
        @Test static func test_4() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "54668a07-58b3-4f44-bfb5-1edee0e3d3eb"
        ...
        @Test static func test_5() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "af48dee2-8d6a-4cf2-addf-e5f7b6ff29bd"
        ...
        @Test static func test_6() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "a1868eaf-c586-44d1-81ef-744e53a71257"
        ...
        @Test static func test_7() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "bfe27c2a-1878-40fa-af8e-4ca3bdce7c45"
            let rawInput = "root = [1,2,2,4,5,5]"
            let expectedOutput = "3"
            let orderMatters = true
        ...
        @Test static func test_8() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "0bdd881b-5f4d-4162-a032-783401d308c2"
        ...
        @Test static func test_9() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "4dd7645c-8532-4abc-8422-7c7ec44b120e"
        ...
        @Test static func test_10() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "8d30650f-1d3c-41a6-8418-e8d70ca83a57"
            let rawInput = "root = [1,2,3,null,null,4,5,null,null,6,7,null,null,8,9]"
            let expectedOutput = "4"
            let orderMatters = true
        ...
        @Test static func test_11() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "10ad8d2f-13cc-418d-a5a2-39413914face"
        ...
        @Test static func test_12() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "86706f40-c353-4058-85bd-240f1b699717"
        ...
        @Test static func test_13() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "783c1539-60ba-4f96-aacb-7cb9dccd5cb9"
        ...
        @Test static func test_14() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "ec52e7fb-1b84-4ae2-ae8e-71c2ea67582f"
        ...
        @Test static func test_15() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "06667d00-9480-4ba8-87e3-878d00dc0461"
            let rawInput = "root = [1,2,null,4,null,5]"
            let expectedOutput = "4"
            let orderMatters = true
        ...
        @Test static func test_16() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "fff8e9fe-c8aa-417d-a731-79b8a7209d53"
        ...
        @Test static func test_17() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "e2ab9274-c100-4d7c-93c2-2a6fa88ad52d"
            let rawInput = "root = [1,2,null,4,5,null,6,7]"
            let expectedOutput = "4"
            let orderMatters = true
        ...
        @Test static func test_18() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "c8b540af-dc9c-424e-bb99-d490f8537602"
        ...
        @Test static func test_19() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "b533649a-4272-4702-a9ad-3316f0dbbd39"
        ...
        @Test static func test_20() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "b9d88f71-5e81-43ea-a999-f1360457d259"
        ...
        @Test static func test_21() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "8edd56f7-0b36-4d01-b736-a96774146b1c"
        ...
        @Test static func test_22() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "52be9360-dfb3-4a2d-9901-ef805164a2d8"
        ...
        @Test static func test_23() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "40c456c1-428d-4411-9194-40310ad20da8"
        ...
        @Test static func test_24() async {
            let slug = "maximum-depth-of-binary-tree"
            let topic = "trees"
            let testId = "7992769b-014d-4721-be36-b8e3b1b5291a"
            let rawInput = "root = [1,2,3,null,null,4,5,null,null,6,7,null,null,8,9,null,null,10,11]"
            let expectedOutput = "6"
            let orderMatters = true
