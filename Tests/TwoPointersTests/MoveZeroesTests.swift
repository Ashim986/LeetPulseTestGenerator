...
@Suite struct MoveZeroesTests {
    ...
    @Test func test_0() async {
        ...
        let testId = "d4bc66bf-9c99-4f27-b3d4-98d0550edf0b"
        let rawInput = "nums = []"
        let expectedOutput = "[]"
    ...
    @Test func test_1() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "26e4dc55-5150-4d5b-8661-f03f314cdb30"
        let rawInput = "nums = [1]"
    ...
    @Test func test_2() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "b97506b0-3348-4523-9fbf-3e22ea193985"
    ...
    @Test func test_3() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "54d5ce31-c3f7-49ae-9aad-1b34391c616d"
    ...
    @Test func test_4() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "cca52ad8-548a-4f5b-b2b2-66800211806f"
    ...
    @Test func test_5() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "5fd1ad4a-1595-400b-bea5-0f62b496afbc"
        let rawInput = "nums = [1,0,1,0,1]"
        let expectedOutput = "[1,1,1,0,0]"
        let orderMatters = true
    ...
    @Test func test_6() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "063757cf-5938-47a9-98da-8e6df298c523"
        let rawInput = "nums = [0,1,0,1,0]"
        let expectedOutput = "[1,1,0,0,0]"
        let orderMatters = true
    ...
    @Test func test_7() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "0f7969c8-1467-467b-9fac-3a8f4d49ce93"
        let rawInput = "nums = [-1,0,-2,0,-3]"
        let expectedOutput = "[-1,-2,-3,0,0]"
        let orderMatters = true
    ...
    @Test func test_8() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "b5fa8469-0e29-4114-a6c8-3c1b93cbd3cc"
    ...
    @Test func test_9() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "971eacd9-2822-4052-9f99-9a530ed054aa"
    ...
    @Test func test_10() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "89eb5552-cda4-4f04-a6b9-620039b278e4"
    ...
    @Test func test_11() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "76cb00c4-b06d-4330-a6b7-97af394ce3fb"
    ...
    @Test func test_12() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "c693101c-f217-434a-8e75-59448e7bad93"
        let rawInput = "nums = [-1000,-2000,-3000,-4000,-5000]"
        let expectedOutput = "[-1000,-2000,-3000,-4000,-5000]"
        let orderMatters = true
    ...
    @Test func test_13() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "4f52385d-e687-46f6-9601-aa45e286bc9f"
        let rawInput = "nums = [0,10,0,20,0]"
        let expectedOutput = "[10,20,0,0,0]"
        let orderMatters = true
    ...
    @Test func test_14() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "c4767665-13cf-451f-ada8-84febfa024be"
        let rawInput = "nums = [0,-10,0,-20,0]"
        let expectedOutput = "[-10,-20,0,0,0]"
        let orderMatters = true
    ...
    @Test func test_15() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "74670e7d-b911-486f-9391-353c75668178"
        let rawInput = "nums = [0,0,10,0,20]"
        let expectedOutput = "[10,20,0,0,0]"
        let orderMatters = true
    ...
    @Test func test_16() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "b526c591-3312-4495-b66d-e4ff3a886ac3"
        let rawInput = "nums = [0,0,-10,0,-20]"
        let expectedOutput = "[-10,-20,0,0,0]"
        let orderMatters = true
    ...
    @Test func test_17() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "e5a6ca00-c34d-4f8b-bd3d-29cc30ce23cb"
        let rawInput = "nums = [10,0,20,0,30]"
        let expectedOutput = "[10,20,30,0,0]"
        let orderMatters = true
    ...
    @Test func test_18() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "eeaa7d62-9994-4f4c-a665-6261c1d909e7"
        let rawInput = "nums = [-10,0,-20,0,-30]"
        let expectedOutput = "[-10,-20,-30,0,0]"
        let orderMatters = true
    ...
    @Test func test_19() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "be385c5b-ec5e-4aa2-b51c-3452d465be6c"
    ...
    @Test func test_20() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "6dafae36-d638-4e81-864f-83860d86be36"
    ...
    @Test func test_21() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "8371a3ef-801a-415a-89a2-2390caa579de"
    ...
    @Test func test_22() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "8b1cfe5b-c873-4698-b1a2-ceb38eb17953"
    ...
    @Test func test_23() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "f773f1c0-95e8-4aca-a751-5a9fdf454d72"
    ...
    @Test func test_24() async {
        let slug = "move-zeroes"
        let topic = "two-pointers"
        let testId = "2e29cb1c-b8c3-4a7d-8bc5-c72c3d1590bc"
