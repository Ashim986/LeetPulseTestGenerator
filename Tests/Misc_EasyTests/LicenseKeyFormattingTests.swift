...
enum LC_license_key_formatting {
    ...
    @Suite struct LicenseKeyFormattingTests {
        ...
        @Test static func test_0() async {
            ...
            let topic = "misc"
            let testId = "2649afe4-f3a7-4f2c-925e-6f67d5c0d719"
            let rawInput = "s = \"5F3Z-2e-9-w\", k = 4"
            let expectedOutput = "\"5F3Z-2E9W\""
            ...
            do {
                ...
                let result = solution.licenseKeyFormatting(p_S, p_K)
        ...
        @Test static func test_1() async {
            let slug = "license-key-formatting"
            let topic = "misc"
            let testId = "c8932654-bc7c-47cc-a657-fa681f247fac"
            let rawInput = "s = \"2-5g-3-J\", k = 2"
            let expectedOutput = "\"2-5G-3J\""
            let orderMatters = true
