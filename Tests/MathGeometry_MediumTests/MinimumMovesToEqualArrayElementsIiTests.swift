...
enum LC_minimum_moves_to_equal_array_elements_ii {
    ...
    @Suite struct MinimumMovesToEqualArrayElementsIiTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "7b78b83c-2721-463b-84ee-b17bf9f4280f"
            let rawInput = "nums = [1]"
        ...
        @Test static func test_1() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "e94d2100-7ca0-4b56-a942-f6003a34d583"
        ...
        @Test static func test_2() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "f167b2ed-083b-4b8d-9458-aa82475e11c0"
        ...
        @Test static func test_3() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "0db1f05e-6189-4244-b1cd-69a45764ce66"
        ...
        @Test static func test_4() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "243a5157-a0b5-495f-9743-b50dc3fbb744"
        ...
        @Test static func test_5() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "c6db902a-f219-4876-97a4-2250de7d36dd"
        ...
        @Test static func test_6() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "ec7cf949-2bd6-4424-b11d-c79ab3da697b"
        ...
        @Test static func test_7() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "30d7b750-175c-4dca-86ce-71db7b0f3737"
        ...
        @Test static func test_8() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "ddfef8f0-364b-4fbd-86a8-1f6198d2c361"
        ...
        @Test static func test_9() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "9959d477-f4de-4ba6-8abc-82e84d394aa7"
        ...
        @Test static func test_10() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "9c41ee66-53b1-4848-a93f-f86e340787f5"
            let rawInput = "nums = [-5,-5,-5,-5,-5]"
            let expectedOutput = "0"
            let orderMatters = true
        ...
        @Test static func test_11() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "a5da8e64-a51b-4bce-be0d-6f4327f2157a"
        ...
        @Test static func test_12() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "8e62ca08-3fe7-4b1b-a1a0-78451c6809f3"
        ...
        @Test static func test_13() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "63b2c050-2813-45ee-b74a-9a87384bf103"
            let rawInput = "nums = [-10,-10,-10,-10,-10,-10,-10,-10,-10,-10]"
            let expectedOutput = "0"
            let orderMatters = true
        ...
        @Test static func test_14() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "a0cd6b15-461f-4082-85a5-893843a8f940"
        ...
        @Test static func test_15() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "b6c044d2-cb87-41ab-a8d2-1d3cf080cf82"
        ...
        @Test static func test_16() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "dad3fae3-1ece-4dab-a251-30c439ae5a8f"
            let rawInput = "nums = [100,200,300,400,500,600,700,800,900,1000]"
            let expectedOutput = "2500"
            let orderMatters = true
        ...
        @Test static func test_17() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "be65ec33-283c-4373-870f-c6508dcca31f"
        ...
        @Test static func test_18() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "81ca5732-3693-4934-ac85-baf3b4c9ad61"
            let rawInput = "nums = [-100,-200,-300,-400,-500,-600,-700,-800,-900,-1000]"
            let expectedOutput = "2500"
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "c9c8f887-b6c9-4670-96e2-0042cf80e32f"
            let rawInput = "nums = [-1000,-900,-800,-700,-600,-500,-400,-300,-200,-100]"
            let expectedOutput = "2500"
            let orderMatters = true
        ...
        @Test static func test_20() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "41eed335-54e8-44b2-9bb8-71842760d5e9"
        ...
        @Test static func test_21() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "c0adc630-159a-40eb-89b7-257b9010c7cc"
        ...
        @Test static func test_22() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "79d362d2-cbd9-4396-86e7-fad7f64d2bab"
            let rawInput = "nums = [100,300,500,700,900,1100,1300,1500,1700,1900]"
        ...
        @Test static func test_23() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "c38e2910-f29a-4d33-836c-28203c442290"
            let rawInput = "nums = [1900,1700,1500,1300,1100,900,700,500,300,100]"
            let expectedOutput = "5000"
            let orderMatters = true
        ...
        @Test static func test_24() async {
            let slug = "minimum-moves-to-equal-array-elements-ii"
            let topic = "math-geometry"
            let testId = "606d9b9b-2e9e-4e26-8015-f7ae5da40656"
            let rawInput = "nums = [-100,-300,-500,-700,-900,-1100,-1300,-1500,-1700,-1900]"
            let expectedOutput = "5000"
            let orderMatters = true
