...
enum LC_find_all_anagrams_in_a_string {
    ...
    @Suite struct FindAllAnagramsInAStringTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "E8ED6B86-8230-4D37-A39F-A1D01F7F7191"
            let rawInput = "cbaebabacd\nabc"
            ...
            guard p_s.count >= 1 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 1 <= s.length, p.length <= 3 * 104")
                return
            }
        ...
        @Test static func test_1() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "3307705A-0CEC-4648-A649-8A007D1CDE8B"
            let rawInput = "abab\nab"
        ...
        @Test static func test_2() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "F551F7A1-C959-4503-8022-6CC04BDEB960"
            let rawInput = "aaaa\naa"
            let expectedOutput = "[0,1,2]"
            let orderMatters = false
        ...
        @Test static func test_3() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "1E3AEAE9-4067-41A1-965B-BCA6DD367D8B"
            let rawInput = "a\na"
        ...
        @Test static func test_4() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "DB94DB9A-419E-4605-834D-0321A2621CA1"
            let rawInput = "abcdef\nxyz"
            let expectedOutput = "[]"
            let orderMatters = false
        ...
        @Test static func test_5() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "4111D426-3BEE-4302-885F-9D3AB1A83329"
            let rawInput = "aaa\naa"
        ...
        @Test static func test_6() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "A204AF03-500A-4936-83B6-FF4827D87DCE"
            let rawInput = "bac\nabc"
            let expectedOutput = "[0]"
            let orderMatters = false
        ...
        @Test static func test_7() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "7E2DB343-3610-4822-A798-5E4051A86819"
            let rawInput = "abcdef\nabcdef"
            let expectedOutput = "[0]"
            let orderMatters = false
        ...
        @Test static func test_8() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "5991F5CC-90F5-4327-805F-AFC4B53F8531"
            let rawInput = "aaaaaa\naaaaa"
            let expectedOutput = "[0,1]"
            let orderMatters = false
        ...
        @Test static func test_9() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "A7BCC4AB-95C6-4CD7-9B7A-CD5C57D1A98F"
            let rawInput = "aaaaaa\naaaa"
            let expectedOutput = "[0,1,2]"
            let orderMatters = false
        ...
        @Test static func test_10() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "E87BFDB8-56EB-4D47-AFBB-B13851361435"
        ...
        @Test static func test_11() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "169F1215-9EAD-4576-8B20-D72CE335D638"
            let rawInput = "def\nabc"
            let expectedOutput = "[]"
            let orderMatters = false
        ...
        @Test static func test_12() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "F1FCAD18-98B8-4C60-B0D2-609D92621BC5"
            let rawInput = "aabac\nabc"
        ...
        @Test static func test_13() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "EE3018ED-0586-4FD3-A060-725DF3229A9A"
            let rawInput = "aaaaaa\na"
        ...
        @Test static func test_14() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "2EA3101C-378F-4F9A-A3AF-B1E184EB18CD"
            let rawInput = "aaaaaa\naa"
            let expectedOutput = "[0,1,2,3,4]"
            let orderMatters = false
        ...
        @Test static func test_15() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "43323990-7242-4C58-B204-6330B5F5A691"
            let rawInput = "b"
        ...
        @Test static func test_16() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "CD973BB7-5AC5-4BBD-8263-C8D8AC606CA8"
            let rawInput = "abcdef\nbca"
            let expectedOutput = "[0]"
            let orderMatters = false
        ...
        @Test static func test_17() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "662EC637-7FED-4102-AA4D-6E52F63A06B8"
            let rawInput = "bba\nab"
            let expectedOutput = "[1]"
            let orderMatters = false
        ...
        @Test static func test_18() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "3024F526-8875-4DBF-807F-526AA4C182C3"
            let rawInput = "abcdabc\nabc"
        ...
        @Test static func test_19() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "1443373B-9D5A-4808-9414-AC5F7B92B48C"
            let rawInput = "acac\naca"
            let expectedOutput = "[0]"
            let orderMatters = false
        ...
        @Test static func test_20() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "2CE0E2E6-303E-496E-904B-3E448DF16527"
            let rawInput = "abcabcabc\nabc"
        ...
        @Test static func test_21() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "D6CFC233-EA27-4255-8B43-A8B9DF8527E5"
            let rawInput = "abcdabcde\nabc"
            let expectedOutput = "[0,4]"
            let orderMatters = false
        ...
        @Test static func test_22() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "B3EC4705-1E14-4D4A-B082-91CFCE168F0D"
            let rawInput = "abcdabcdabcd\nabcd"
        ...
        @Test static func test_23() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "AAB2EC11-7945-4D28-B701-E760C9360993"
            let rawInput = "abc"
        ...
        @Test static func test_24() async {
            let slug = "find-all-anagrams-in-a-string"
            let topic = "sliding-window"
            let testId = "7AE039E7-8E90-4E10-BF2F-82647A3DBEEF"
            let rawInput = "def"
            let expectedOutput = "[1,2,3]"
            let orderMatters = false
