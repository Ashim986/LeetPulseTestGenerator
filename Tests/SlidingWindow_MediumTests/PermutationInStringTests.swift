    ...
    @Suite struct PermutationInStringTests {
        ...
        @Test static func test_0() async {
            ...
            guard p_s1.count >= 1 && p_s1.count <= 104 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 1 <= s1.length, s2.length <= 104")
                return
            }
