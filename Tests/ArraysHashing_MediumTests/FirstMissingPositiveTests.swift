...
enum LC_first_missing_positive {
    ...
    @Suite struct FirstMissingPositiveTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "538a9ad1-24e2-476e-8908-79481dbb22c0"
        ...
        @Test static func test_1() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "fd5c9438-f8e4-43ca-9e15-28bf0dcd4762"
            let rawInput = "nums = []"
        ...
        @Test static func test_2() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "5310afe8-665c-4ab0-b973-8d6624932689"
            let rawInput = "nums = [1]"
        ...
        @Test static func test_3() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "a9322331-48b0-4aa9-b7e0-f892aabe6577"
            let rawInput = "nums = [2]"
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_4() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "c459ca8d-1411-4acf-99df-f5b5e2e498cb"
            let rawInput = "nums = [-1,-2,-3]"
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_5() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "d43dfba7-3727-417a-be61-b978dfa342f9"
        ...
        @Test static func test_6() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "c96503e9-c660-4472-9b7e-40282fc2ffd7"
        ...
        @Test static func test_7() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "5c457c2a-1d8b-440d-a181-71eb64beb50b"
        ...
        @Test static func test_8() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "806dba28-eb96-4839-a021-1c14a8bee59b"
            let rawInput = "nums = [-1000,-1001,-1002]"
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_9() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "5223e761-76b8-4fdf-9ddf-2fa88d3dbc56"
        ...
        @Test static func test_10() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "c438996d-03af-4ac3-8523-fd0a752a8f26"
        ...
        @Test static func test_11() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "1e534cee-ede3-41c3-a777-61eeb1563272"
        ...
        @Test static func test_12() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "0ad33215-f7df-402a-8d99-f8d28e76bfd3"
        ...
        @Test static func test_13() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "40c67e34-e83f-4d2d-bb72-573447b1eb11"
        ...
        @Test static func test_14() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "287cc096-7e8d-44fb-adf2-aedb77ef70aa"
            let rawInput = "nums = [-1,0,1,2,3]"
            let expectedOutput = "4"
            let orderMatters = true
        ...
        @Test static func test_15() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "a792a7a0-e423-4757-bb67-a94a69a7443d"
        ...
        @Test static func test_16() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "35cb90da-f40d-41bc-a618-d90bcb2ead65"
        ...
        @Test static func test_17() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "19730361-0bcd-40e5-b102-b1986cf0bb60"
        ...
        @Test static func test_18() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "251dac3f-42ac-4d9d-8d19-739f11ed1aa1"
        ...
        @Test static func test_19() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "83951ab9-db3e-4a2f-88aa-89406e606434"
        ...
        @Test static func test_20() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "a805c1a8-e814-4abb-a19a-3bd5ef675fc7"
            let rawInput = "nums = [-1,-1,-1,-1,-1]"
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_21() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "2cb601af-b171-4c75-8595-ec4b56bda4b0"
        ...
        @Test static func test_22() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "5ac0e6d3-ba3d-4346-8744-624dadc8f88e"
        ...
        @Test static func test_23() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "54e8b5aa-e697-451f-ba0e-4ba8acbabbe7"
        ...
        @Test static func test_24() async {
            let slug = "first-missing-positive"
            let topic = "arrays-hashing"
            let testId = "23f78d32-f341-49d0-b9ab-3bcb61328056"
