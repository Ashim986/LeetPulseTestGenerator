...
enum LC_reverse_only_letters {
    ...
    @Suite struct ReverseOnlyLettersTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "4a1f0cbe-c0a3-4395-b375-04089b874310"
            let rawInput = "S = \"abc\""
            ...
            do {
                ...
                let result = solution.reverseOnlyLetters(p_S)
        ...
        @Test static func test_1() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "9a3b7fb4-6e4c-4fa2-9ed2-e11870456df7"
            let rawInput = "S = \"a1b2c3\""
            let expectedOutput = "\"c1b2a3\""
            let orderMatters = true
        ...
        @Test static func test_2() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "f1d87324-5f2f-4bb4-be40-cc2515c9ee5b"
            let rawInput = "S = \"-\""
            let expectedOutput = "\"-\""
            let orderMatters = true
        ...
        @Test static func test_3() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "bde15436-6f74-4675-ab73-e81c9e0ce5b8"
            let rawInput = "S = \"123\""
        ...
        @Test static func test_4() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "218545e9-93f3-442b-926f-4ab591438251"
            let rawInput = "S = \"abc123\""
            let expectedOutput = "\"cba123\""
            let orderMatters = true
        ...
        @Test static func test_5() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "230e5f6e-120d-4516-9fe4-0eb72d32980d"
            let rawInput = "S = \"aA\""
        ...
        @Test static func test_6() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "6beba1e4-eb47-4de2-9002-eedb6a592579"
            let rawInput = "S = \"a!b\""
        ...
        @Test static func test_7() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "74d69842-6ced-4043-9cb3-140caf260c27"
            let rawInput = "S = \"a b\""
            let expectedOutput = "\"b a\""
            let orderMatters = true
        ...
        @Test static func test_8() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "34def15f-d921-4c9d-8d6a-0596eed6d891"
            let rawInput = "S = \"a,b\""
            let expectedOutput = "\"b,a\""
            let orderMatters = true
        ...
        @Test static func test_9() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "8d02e723-a93d-47a7-9008-37312cf80782"
            let rawInput = "S = \"a_b\""
            let expectedOutput = "\"b_a\""
            let orderMatters = true
        ...
        @Test static func test_10() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "f134a1b6-9256-419a-b78d-267646e523a6"
            let rawInput = "S = \"a-b\""
            let expectedOutput = "\"b-a\""
            let orderMatters = true
        ...
        @Test static func test_11() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "aa653665-8bb0-4750-9426-0662e7169460"
            let rawInput = "S = \"a/b\""
            let expectedOutput = "\"b/a\""
            let orderMatters = true
        ...
        @Test static func test_12() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "7a0b01fe-30ab-4995-a13f-c611e46f79e5"
            let rawInput = "S = \"a\\b\""
            let expectedOutput = "\"b\\a\""
            let orderMatters = true
        ...
        @Test static func test_13() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "8832afeb-48bf-48c7-bf6a-cd7916e81f40"
            let rawInput = "S = \"a|b\""
            let expectedOutput = "\"b|a\""
            let orderMatters = true
        ...
        @Test static func test_14() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "84edf461-cd51-43b8-89ec-527b559b9119"
            let rawInput = "S = \"a~b\""
            let expectedOutput = "\"b~a\""
            let orderMatters = true
        ...
        @Test static func test_15() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "3a22544a-aa5d-47c7-9e16-32af841f70ac"
            let rawInput = "S = \"a^b\""
            let expectedOutput = "\"b^a\""
            let orderMatters = true
        ...
        @Test static func test_16() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "69d488fb-a209-4986-a06d-20702e496263"
            let rawInput = "S = \"a*b\""
            let expectedOutput = "\"b*a\""
            let orderMatters = true
        ...
        @Test static func test_17() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "3b4ebf06-c2f5-4158-91f7-ae8ceb21e444"
            let rawInput = "S = \"a(b)\""
            let expectedOutput = "\"b(a)\""
            let orderMatters = true
        ...
        @Test static func test_18() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "097da7ea-19e3-4448-b1b2-3702c4c10ff8"
            let rawInput = "S = \"a[b]\""
            let expectedOutput = "\"b[a]\""
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "c02f8d29-c041-4403-811d-3e36977b5a47"
            let rawInput = "S = \"a{b}\""
            let expectedOutput = "\"b{a}\""
            let orderMatters = true
        ...
        @Test static func test_20() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "6c209120-dcb3-4cdc-89d8-4af68117cbc1"
            let rawInput = "S = \"a<b>\""
            let expectedOutput = "\"b<a>\""
            let orderMatters = true
        ...
        @Test static func test_21() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "1eba6fe3-fbdb-47ea-99c1-eb08806a93e6"
            let rawInput = "S = \"a=b\""
            let expectedOutput = "\"b=a\""
            let orderMatters = true
        ...
        @Test static func test_22() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "f7f74a78-88a7-46fe-8227-34caeaea84e7"
            let rawInput = "S = \"a+b\""
            let expectedOutput = "\"b+a\""
            let orderMatters = true
        ...
        @Test static func test_23() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "036ee7c2-5852-4d56-9773-2af3dc036840"
            let rawInput = "S = \"\""
            let expectedOutput = "\"\""
            let orderMatters = true
        ...
        @Test static func test_24() async {
            let slug = "reverse-only-letters"
            let topic = "two-pointers"
            let testId = "9ec4a459-5401-4469-8799-966c95b107f5"
            let rawInput = "S = \"a\""
