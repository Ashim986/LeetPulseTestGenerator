...
enum LC_k_closest_points_to_origin {
    ...
    @Suite struct KClosestPointsToOriginTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "6ae9e40f-6021-490a-a839-7217a44289e5"
            let rawInput = "points = [[0,0]], k = 1"
            ...
            guard p_k >= 1 && p_k <= 104 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 1 <= k <= points.length <= 104")
                return
            }
            ...
            do {
                ...
                let result = solution.kClosest(p_points, p_k)
        ...
        @Test static func test_1() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "205ab388-de13-4af7-b1f2-a541c50846f5"
            let rawInput = "points = [[1,1]], k = 1"
        ...
        @Test static func test_2() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "bc081b38-f26e-4f0a-8c14-b677547f7cb2"
            let rawInput = "points = [[-1,-1]], k = 1"
            let expectedOutput = "[[-1,-1]]"
            let orderMatters = false
        ...
        @Test static func test_3() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "98efb7ba-2fbe-43b3-be9a-a378aceac734"
            let rawInput = "points = [[1,2],[1,2]], k = 1"
        ...
        @Test static func test_4() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "67842e2d-0f7a-4ad2-93ae-f5dafb879db8"
            let rawInput = "points = [[1,2],[1,2],[1,2]], k = 2"
        ...
        @Test static func test_5() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "cb6a9368-815a-4933-8c8b-8b3da8bb1209"
            let rawInput = "points = [[-1,0],[0,1],[1,0]], k = 2"
        ...
        @Test static func test_6() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "54f03a19-8738-4b96-b56d-4d217d8ac1c0"
            let rawInput = "points = [[-1,0],[0,1],[1,0]], k = 1"
        ...
        @Test static func test_7() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "355f37de-619e-431f-9441-0ecb79de5ff2"
            let rawInput = "points = [[-1,0],[0,1],[1,0]], k = 3"
            let expectedOutput = "[[-1,0],[0,1],[1,0]]"
            let orderMatters = false
        ...
        @Test static func test_8() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "13367eaf-496e-46c1-9663-6a1181061f0d"
            let rawInput = "points = [[-10,-10],[-10,10],[10,-10],[10,10]], k = 1"
        ...
        @Test static func test_9() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "363d241a-5b3c-40d2-8e8b-86dffa2b126d"
            let rawInput = "points = [[-10,-10],[-10,10],[10,-10],[10,10]], k = 2"
            let expectedOutput = "[[-10,-10],[-10,10]]"
            let orderMatters = false
        ...
        @Test static func test_10() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "3079ac63-4070-4e7f-843d-9a566f8ec340"
            let rawInput = "points = [[-10,-10],[-10,10],[10,-10],[10,10]], k = 3"
            let expectedOutput = "[[-10,-10],[-10,10],[10,-10]]"
            let orderMatters = false
        ...
        @Test static func test_11() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "d20ff1d4-aef6-4005-9a3e-a5725565ec67"
            let rawInput = "points = [[-10,-10],[-10,10],[10,-10],[10,10]], k = 4"
            let expectedOutput = "[[-10,-10],[-10,10],[10,-10],[10,10]]"
            let orderMatters = false
        ...
        @Test static func test_12() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "2b5c50ae-9b70-425d-ac03-e49806ec2c50"
            let rawInput = "points = [], k = 1"
            let expectedOutput = "[]"
            let orderMatters = false
        ...
        @Test static func test_13() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "7934f984-0219-4fef-890a-e2fc6e7e9730"
            let rawInput = "points = [[1,1]], k = 0"
            let expectedOutput = "[]"
            let orderMatters = false
        ...
        @Test static func test_14() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "fbf454d1-d13d-4130-a46d-2fe8aab2c590"
            let rawInput = "points = [[1,1],[2,2]], k = 0"
            let expectedOutput = "[]"
            let orderMatters = false
        ...
        @Test static func test_15() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "31cc9e8e-7bef-42d3-8b09-6b26a2638ba5"
            let rawInput = "points = [[1,1],[1,1],[1,1]], k = 1"
            let expectedOutput = "[[1,1]]"
            let orderMatters = false
        ...
        @Test static func test_16() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "c15f7b20-9954-42d0-8fae-7453c06214b1"
            let rawInput = "points = [[1,1],[1,1],[1,1]], k = 2"
        ...
        @Test static func test_17() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "c5ca056d-3b5f-46b7-beb6-4f9122f366c8"
            let rawInput = "points = [[1,1],[1,1],[1,1]], k = 3"
        ...
        @Test static func test_18() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "23759d88-0534-46ad-9894-3fb760354016"
            let rawInput = "points = [[1,2],[3,4]], k = 1"
        ...
        @Test static func test_19() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "158510e7-7151-4728-a7d5-b7dcea2a1d92"
            let rawInput = "points = [[1,2],[3,4]], k = 2"
        ...
        @Test static func test_20() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "fb2a9ce7-0596-4907-922f-af50c244efd7"
            let rawInput = "points = [[1,2],[3,4],[5,6]], k = 1"
        ...
        @Test static func test_21() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "fe58485f-4c33-494d-b210-60f6fc1f1b24"
            let rawInput = "points = [[1,2],[3,4],[5,6]], k = 2"
            let expectedOutput = "[[5,6],[3,4]]"
            let orderMatters = false
        ...
        @Test static func test_22() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "13fe16ed-ace3-49ec-a0b6-1e333c7bc198"
            let rawInput = "points = [[1,2],[3,4],[5,6]], k = 3"
            let expectedOutput = "[[5,6],[3,4],[1,2]]"
            let orderMatters = false
        ...
        @Test static func test_23() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "48f0cad1-090b-4eb5-a802-8fac9cb5a0e9"
            let rawInput = "points = [[0,0],[0,1],[1,0]], k = 2"
        ...
        @Test static func test_24() async {
            let slug = "k-closest-points-to-origin"
            let topic = "heap-priority-queue"
            let testId = "110b62d0-8d16-4d59-b77a-b756d76ef329"
            let rawInput = "points = [[0,0],[0,1],[1,0]], k = 1"
