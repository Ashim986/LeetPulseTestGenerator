...
enum LC_longest_palindromic_subsequence {
    ...
    @Suite struct LongestPalindromicSubsequenceTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "3d242cea-bb75-49da-ba45-2ae36a287bc4"
            let rawInput = "s = \"\""
        ...
        @Test static func test_1() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "9d4b52f5-4893-4ff0-8342-de8333016462"
            let rawInput = "s = \"a\""
        ...
        @Test static func test_2() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "b87ff542-2a55-405e-846b-058fd10b6582"
            let rawInput = "s = \"ab\""
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_3() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "88ee8814-72df-4c0a-ab13-cdccdf582b1c"
            let rawInput = "s = \"aa\""
        ...
        @Test static func test_4() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "775f82cb-78f8-4b30-ae3e-141552c8d0bb"
            let rawInput = "s = \"aba\""
        ...
        @Test static func test_5() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "77a7a26f-640f-476e-8a3b-2d423d027d4d"
            let rawInput = "s = \"abba\""
        ...
        @Test static func test_6() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "92148cf9-ed5c-43e0-82f6-6cbdc8baed95"
        ...
        @Test static func test_7() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "c9ae58ef-edb2-4a7b-ab3b-04aa79998399"
        ...
        @Test static func test_8() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "a3612db1-1d86-4d4b-a8f4-62c92fb6687d"
        ...
        @Test static func test_9() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "295e8716-dd83-4366-9f9b-3ce099a312d5"
        ...
        @Test static func test_10() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "cf6f14d1-9182-4ba4-b17d-861c86de2203"
        ...
        @Test static func test_11() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "2c7adf48-76a7-46c1-b6e1-fec0297b6a0b"
        ...
        @Test static func test_12() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "31b16870-bdc9-4d13-bc4a-29d5382d9a7c"
        ...
        @Test static func test_13() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "62861e53-c768-47d5-8b21-72001aee925f"
            let rawInput = "s = \"hgfedcba\""
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_14() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "de26c208-2fbb-4d05-bf69-831eff3168b1"
            let rawInput = "s = \"aaaaaaab\""
        ...
        @Test static func test_15() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "651338cb-8f5b-4de6-a726-c1b5786d9e35"
            let rawInput = "s = \"baaaaaaa\""
            let expectedOutput = "7"
            let orderMatters = true
        ...
        @Test static func test_16() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "3f97cf0b-4ec8-4406-bc35-b83318759555"
        ...
        @Test static func test_17() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "0093afa2-be56-4fb8-b1fa-7b56db53dcf7"
        ...
        @Test static func test_18() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "eda8f11e-c1f9-4c07-b29d-72e4898194a8"
            let rawInput = "s = \"ihgfedcba\""
            let expectedOutput = "1"
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "86a5975b-9a1a-41a6-b8db-e63917964e12"
            let rawInput = "s = \"aaaaaaaaaaaa\""
        ...
        @Test static func test_20() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "e5339eb0-821c-4a2d-bbb2-0205bb357991"
        ...
        @Test static func test_21() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "9c59aed1-a0e4-4c1e-b340-ac89b14b0154"
        ...
        @Test static func test_22() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "5d3c3878-f797-4c5b-baac-11646d9f8bf7"
            let rawInput = "s = \"aaaaaaaaaaaaaaaa\""
        ...
        @Test static func test_23() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "181b04cd-a9fc-41f6-8cdc-0aabd7a87e05"
        ...
        @Test static func test_24() async {
            let slug = "longest-palindromic-subsequence"
            let topic = "dynamic-programming"
            let testId = "ab811c82-7924-4718-8c42-a78acde50e94"
