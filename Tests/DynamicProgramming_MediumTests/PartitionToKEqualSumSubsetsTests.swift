...
enum LC_partition_to_k_equal_sum_subsets {
    ...
    @Suite struct PartitionToKEqualSumSubsetsTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "f8f2f333-2ee4-4ef7-89e4-9f774f964b75"
            ...
            guard p_k >= 1 && p_k <= 16 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 1 <= k <= nums.length <= 16")
                return
            }
        ...
        @Test static func test_1() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "0e1a3252-c55e-4bbd-bdd5-455a3ec11ee7"
            let rawInput = "nums = [10, 10, 10, 7, 7, 7], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_2() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "9eb07f5c-624d-402e-b4a2-068c5b0f00d5"
            let rawInput = "nums = [1, 1, 1, 1, 1, 1, 1, 1, 1], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_3() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "fce2e45a-6230-4414-8ee4-75b22aed17e1"
        ...
        @Test static func test_4() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "7537e3a3-b059-4cb1-8f74-9abbde385453"
        ...
        @Test static func test_5() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "ea23f01c-1aba-428b-a0b5-10436d4a3995"
            let rawInput = "nums = [1, 1, 1, 1, 1, 1], k = 2"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_6() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "ea6ac4aa-617c-4a51-ba1e-d56e328f0cf2"
            let rawInput = "nums = [10, 10, 10, 10, 10, 10], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_7() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "5415b788-e176-4d9b-a1c7-3e53e80fdb5d"
            let rawInput = "nums = [1, 1, 1, 1, 1, 1, 1, 1], k = 4"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_8() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "500ce4f6-f35c-48e9-9ce5-3524e52069a9"
        ...
        @Test static func test_9() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "34af9b42-8eda-444e-b288-b5aa885149db"
        ...
        @Test static func test_10() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "903d6556-b99d-4529-8dbb-0d771100fb18"
        ...
        @Test static func test_11() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "e525412a-3520-4c57-b695-97b5c7e2391d"
        ...
        @Test static func test_12() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "e8c471da-e924-4782-81a7-ba240e9eeb34"
        ...
        @Test static func test_13() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "c45a8634-af22-429e-9ec4-0dec850b9837"
        ...
        @Test static func test_14() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "0c8977a7-bd86-4471-9d58-73ce2b5f3a15"
        ...
        @Test static func test_15() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "04fa92fd-bdd8-4d10-bdb9-67aa71950a03"
        ...
        @Test static func test_16() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "0d6e7f6c-77ea-4f2f-8caf-301b3f161db1"
            let rawInput = "nums = [1, 1, 1], k = 4"
            let expectedOutput = "false"
            let orderMatters = true
        ...
        @Test static func test_17() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "446c4039-9b36-45bc-b6ed-f466ed6045a7"
            let rawInput = "nums = [-1, -1, -1], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_18() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "bb0cf062-be37-4ddf-a348-b32757ffb72d"
            let rawInput = "nums = [-1, 1, -1], k = 3"
            let expectedOutput = "false"
            let orderMatters = true
        ...
        @Test static func test_19() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "e7e22714-1abf-4480-9dcd-a88a500755cd"
            let rawInput = "nums = [0, 0, 0], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_20() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "1160c85b-431a-4dd9-96c7-f2b340de0906"
            let rawInput = "nums = [0, 1, 0], k = 3"
            let expectedOutput = "false"
            let orderMatters = true
        ...
        @Test static func test_21() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "8ba9c54b-9acb-47aa-a5d8-c2abb9f01ee1"
            let rawInput = "nums = [1000, 1000, 1000], k = 3"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_22() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "3fa71619-9409-4d07-b0a1-84c85f76e053"
            let rawInput = "nums = [1000, 1001, 1002], k = 3"
            let expectedOutput = "false"
            let orderMatters = true
        ...
        @Test static func test_23() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "a9b6c3af-1a70-4774-ab9a-becff617ba6b"
        ...
        @Test static func test_24() async {
            let slug = "partition-to-k-equal-sum-subsets"
            let topic = "dynamic-programming"
            let testId = "880f7b5e-436b-4dbe-9334-e395df59403d"
