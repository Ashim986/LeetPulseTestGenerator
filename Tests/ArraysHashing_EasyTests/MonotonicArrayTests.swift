...
enum LC_monotonic_array {
    ...
    @Suite struct MonotonicArrayTests {
        ...
        @Test static func test_0() async {
            ...
            let testId = "b62a88cf-d61e-44ac-9f43-2e40fe6d84a4"
            let rawInput = "nums = []"
        ...
        @Test static func test_1() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "4868d6c8-07bb-473e-931f-41de01f97a2f"
            let rawInput = "nums = [1]"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_2() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "0a7bfda4-f986-443e-ab20-4c57ff08d79e"
        ...
        @Test static func test_3() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "77182d87-8be1-4d3c-8ae2-98c89ff9a9a1"
        ...
        @Test static func test_4() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "19b3fa9e-b16c-40da-a8d2-b83d629d356f"
        ...
        @Test static func test_5() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "ba1e53db-52c9-4ae3-a89a-42e6710d5b18"
        ...
        @Test static func test_6() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "de7b9613-bff0-4c5d-9b3b-c74dccba26dc"
            let rawInput = "nums = [-1, -2, -3, -4, -5]"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_7() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "46e15e79-abc5-4f2d-aec5-a319ccfd5526"
            let rawInput = "nums = [-5, -4, -3, -2, -1]"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_8() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "ac280349-5155-4c90-a505-9f8ad18a7606"
        ...
        @Test static func test_9() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "f3ed26a4-c128-4a73-8d57-bab6df6db472"
        ...
        @Test static func test_10() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "cd631360-63c9-44dc-bd41-fd0acebf885a"
        ...
        @Test static func test_11() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "d5e38105-f3c3-4352-bec3-323b2cdd8af6"
            let rawInput = "nums = [1, -2, 3, -4, 5]"
        ...
        @Test static func test_12() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "579b39a2-1ecf-404b-875d-751d3c0b7863"
        ...
        @Test static func test_13() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "7e658687-b81e-4de1-ac30-ca6c029ad314"
            let rawInput = "nums = [5, 4, 3, 2, 3]"
            let expectedOutput = "false"
            let orderMatters = true
        ...
        @Test static func test_14() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "3771378a-a30e-4c69-bb5e-066b2e6aa267"
        ...
        @Test static func test_15() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "fd9054a1-5c2b-463b-b3e0-d375f8646eae"
            let rawInput = "nums = [3, 2, 2, 1, 1]"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_16() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "4042d054-aca5-463e-886d-28a3bf588ab9"
        ...
        @Test static func test_17() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "9eeac7d7-738b-40f3-9386-bf18fefb75e0"
            let rawInput = "nums = [-1000, -1000, -1000, -1000, -1000]"
            let expectedOutput = "true"
            let orderMatters = true
        ...
        @Test static func test_18() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "4e31044a-de6c-4197-b21c-707ab6f0cbbe"
        ...
        @Test static func test_19() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "78ce3080-8fa6-4948-ada7-1ee27d7a7ae7"
        ...
        @Test static func test_20() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "179bd940-05ca-47a4-bbe0-06729cec7f67"
        ...
        @Test static func test_21() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "b085765c-e59f-49c0-af19-df8b431d84cc"
        ...
        @Test static func test_22() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "90f0e59a-135f-483f-a026-a6b8c1293d27"
        ...
        @Test static func test_23() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "1e880315-7376-42ea-b695-e393427f70a2"
        ...
        @Test static func test_24() async {
            let slug = "monotonic-array"
            let topic = "arrays-hashing"
            let testId = "08390dc0-34e8-49e3-8cb5-7c7844694a6a"
