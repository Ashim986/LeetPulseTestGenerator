...
@Suite struct TwoSumTests {
    ...
    @Test func test_0() async {
        ...
        let testId = "4B7827CE-A154-4E5C-A002-32C9E73DE97C"
        ...
        guard p_nums.count >= 2 && p_nums.count <= 10000 else {
            await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 2 <= nums.length <= 10^4")
            return
        }
        ...
        guard p_target >= -1000000000 && p_target <= 1000000000 else {
            await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: -10^9 <= target <= 10^9")
            return
        }
    ...
    @Test func test_1() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "CFAA5567-2FEF-4638-9C4B-AB9CB5116DD1"
        let rawInput = "[3, 2, 4]\n6"
    ...
    @Test func test_2() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "E79167CB-ABC8-487F-AA70-9F6CDD1C9F85"
        let rawInput = "[3, 3]\n6"
        let expectedOutput = "[0,1]"
        let orderMatters = false
    ...
    @Test func test_3() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "089F1CC7-347A-45DD-AA6A-6E6D2DEA32B4"
    ...
    @Test func test_4() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "B0D421D8-D792-4F6C-9D0A-21D1592ED3B1"
    ...
    @Test func test_5() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "99966CC1-EDB4-4A31-83CA-67CA5B3C6393"
    ...
    @Test func test_6() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "E0EEEAE4-D798-4329-A0DF-41CFE7F3C6F8"
        let rawInput = "[0, 1, 2, 3, 4, 5]\n1"
        let expectedOutput = "[0, 1]"
        let orderMatters = false
    ...
    @Test func test_7() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "e0ae2abb-3189-47c9-a050-5e8e9c1eb6c2"
        let rawInput = "[1,2,3]\n4"
    ...
    @Test func test_8() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "3508eead-3ad8-46ac-89e5-7ca57a8cea11"
        let rawInput = "[1,1]\n2"
        let expectedOutput = "[0,1]"
        let orderMatters = false
    ...
    @Test func test_9() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "23089d02-2270-48a8-a374-c33052e6b697"
    ...
    @Test func test_10() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "f705e255-7ee6-4a47-8c13-14cebe97a272"
        let rawInput = "[-1,-2,-3]\n-3"
        let expectedOutput = "[0,1]"
        let orderMatters = false
    ...
    @Test func test_11() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "3a9e7fc5-044a-4eec-9cbd-fd98bfbbc1a5"
        let rawInput = "[-10,0,10]\n0"
        let expectedOutput = "[0,2]"
        let orderMatters = false
    ...
    @Test func test_12() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "52f7bc25-2d95-47b2-8e9d-11e516dba13c"
    ...
    @Test func test_13() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "b3ead9da-7838-422a-85f9-887dddf141aa"
    ...
    @Test func test_14() async {
        let slug = "two-sum"
        let topic = "arrays-hashing"
        let testId = "B7972C44-67AE-4CB7-B888-3430F2B26DC4"
        let rawInput = "[1, 0, -1]\n-1"
        let expectedOutput = "[1,2]"
        let orderMatters = false
