    ...
    @Suite struct BinaryWatchTests {
        ...
        @Test static func test_0() async {
            ...
            guard p_turnedOn >= 0 && p_turnedOn <= 10 else {
                await ResultRecorderActor.shared.record(slug: slug, topic: topic, testId: testId, input: rawInput, originalExpected: expectedOutput, computedOutput: "", isValid: false, status: "parse_error", orderMatters: orderMatters, errorMessage: "Constraint violation: 0 <= turnedOn <= 10")
                return
            }
